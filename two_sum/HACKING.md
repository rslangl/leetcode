...
hidden if the `two_sum_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `two_sum_DEVELOPER_MODE` to the configure
...
Runs the executable target `two_sum_exe`.
